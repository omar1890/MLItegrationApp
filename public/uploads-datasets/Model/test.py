...
seq_path ='/Users/hp/Desktop/project/Rss/test/test_seq_data/'
png_path ='/Users/hp/Desktop/project/Rss/test/test_labelpng/'
testset_path ='/Users/hp/Desktop/project/Rss/test/test_set/'
test_one_path ='/Users/hp/Desktop/project/Rss/test/test_one_base/'
...
for l in testDir:
    ...
    prediction = validation.evaluate()
    #print("*********************************************************************")
    print(prediction)
    #prediction_new = [prediction[0][0][0],prediction[0][0][1],prediction[0][0][2]]
    prediction_new = [prediction[0][0],prediction[0][1],prediction[0][2]]
